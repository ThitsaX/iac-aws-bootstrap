...
module "gitlab" {
  source                  = "git::https://github.com/thitsax/iac-shared-modules.git//aws/gitlab?ref=2.1.13.3"
...
module "nexus" {
  source                     = "git::https://github.com/thitsax/iac-shared-modules.git//aws/nexus?ref=v2.1.13.3"
